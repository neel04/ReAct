...
def dt_net_1d(width, **kwargs):
    return DTNet1D(BasicBlock, 8, width, recall=False)


def dt_net_recall_1d(width, **kwargs):
    return DTNet1D(BasicBlock, 8, width, recall=True)


def dt_net_gn_1d(width, **kwargs):
    return DTNet1D(BasicBlock, 8, width, recall=False, group_norm=True)


def dt_net_recall_gn_1d(width, **kwargs):
    return DTNet1D(BasicBlock, 8, width, recall=True, group_norm=True)
